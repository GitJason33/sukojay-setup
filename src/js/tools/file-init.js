...
function Folders() {
    ...
    createFolder("src/styles/css");
    createFolder("src/styles/sass");
    createFolder("src/styles/sass/helpers");
    createFolder("src/styles/sass/components");
    createFolder("src/styles/sass/responsive");
    createFolder("build");
}
function Files() {
    ...
    createFile("src/tools/file-handler.ts", FileHandler);
    ...
    createFile("src/styles/sass/components/static-comps.txt", () => `like header, footer, navbar, etc.`);
    createFile("src/styles/sass/responsive/read.txt", () => `all responsiveness here`);
...
//# sourceMappingURL=file-init.js.map